...
<template>
  <DocsContainer>
    ...
    <DocsSection title="基础用法">
      <p class="text-sm text-base-content/60 mb-4">最简单的轮播实现，包含导航按钮和指示器。</p>
    ...
    <DocsSection title="淡入淡出效果">
      <p class="text-sm text-base-content/60 mb-4">
        使用 <code class="bg-base-200 px-2 py-1 rounded">carousel-fade</code>
        class 启用淡入淡出过渡效果。
      </p>
    ...
    <DocsSection title="带标题的轮播">
      <p class="text-sm text-base-content/60 mb-4">
        使用 <code class="bg-base-200 px-2 py-1 rounded">carousel-caption</code>
        在轮播项上显示标题和描述。
      </p>
    ...
    <DocsSection title="缩略图导航">
      <p class="text-sm text-base-content/60 mb-4">通过缩略图快速导航到指定的轮播项。</p>
    ...
    <DocsSection title="尺寸变体">
      <p class="text-sm text-base-content/60 mb-4">使用不同的 class 控制轮播的高度。</p>
    ...
    <DocsSection title="变量定制">
      ...
      <div class="bg-base-200 p-4 rounded-lg">
        ...
        <ul class="space-y-2 text-sm">
          <li>
            <code class="bg-base-100 px-2 py-1 rounded"> --carousel-md-height </code>
            - 中型轮播高度（默认 16rem）
          </li>
          <li>
            <code class="bg-base-100 px-2 py-1 rounded"> --carousel-duration-slide </code>
            - 滑动动画时长
          </li>
          <li>
            <code class="bg-base-100 px-2 py-1 rounded"> --carousel-indicator-active-bg </code>
            - 激活指示器颜色
          </li>
          <li>
            <code class="bg-base-100 px-2 py-1 rounded"> --carousel-button-height-md </code>
            - 导航按钮高度
          </li>
          <li>
            <code class="bg-base-100 px-2 py-1 rounded"> --carousel-button-bg-opacity </code>
            - 按钮背景透明度
          </li>
        </ul>
      </div>
