...
<template>
  <DocsContainer>
    ...
    <DocsHeader
      title="手风琴组件"
      description="特殊的折叠的容器组件，详情请看 collapse 组件文档。"
    />
...
npm install tailwindcss@latest postcss autoprefixer</pre
          ...
          >
            ...
            <div class="collapse-content">
              <p class="text-sm text-base-content/60 pt-2">
                直接在 HTML 元素上应用
                <code class="px-1.5 py-0.5 bg-base-100 rounded text-xs">collapse</code>
      ...
      <div class="mt-4 p-4 bg-accent/10 border border-accent/20 rounded-lg">
        <p class="text-sm">
          ...
          <code class="px-1.5 py-0.5 bg-base-200 rounded text-xs font-mono">name</code>
          属性，并且使用
          <code class="px-1.5 py-0.5 bg-base-200 rounded text-xs font-mono"
            >&lt;label for="..."&gt;</code
          >
          关联 input 的 id。
        </p>
